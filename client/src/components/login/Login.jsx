            ...
            <section id='login-page' className="auth flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-18 m-[60px]">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form id='login' method="POST" className="space-y-6" onSubmit={submitHandler}>
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900 focus:text-gray-900">
                                Email address
                            </label>
                            <div className="mt-2">
                                <input
                                    ...
                                    required
                                    autoComplete="email"
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 focus:text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                />
                            </div>
                        </div>
